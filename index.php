        ...
        <div class="container" id="about">
            <div class="row justify-content-center">
                <div class="col-12 col-md-12 align-center">
                    ...
                    <h2 class="mbr-section-title align-center mbr-fonts-style mbr-bold display-2">CHOOSE & ENJOY</h2>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center align-items-start">
                ...
                <div class="card px-3 py-4 col-md-4">
                    <div class="card-wrapper flip-card">
                        <div class="card-img">
                            <img src="assets/images/03.jpg" alt="Business Website Templates">
                ...
                <div class="card px-3 py-4 col-md-4">
                    <div class="card-wrapper flip-card">
                        <div class="card-img">
                            <img src="assets/images/04.jpg" alt="Business Website Templates">
                            <div class="img-text mbr-text mbr-fonts-style align-left mbr-white display-4">
                                HEADPHONES
                            </div>
                        </div>
                ...
                <div class="card px-3 py-4 col-md-4">
                    <div class="card-wrapper flip-card">
                        <div class="card-img">
                            <img src="assets/images/05.jpg" alt="html business template" title="">
                            <div class="img-text mbr-text mbr-fonts-style align-left mbr-white display-4">
                                HEADPHONES
                            </div>
                        </div>
